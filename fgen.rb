...
begin
	...
	fonts = ["\xf0\x9d\x93\xaa" ,"\xf0\x9d\x90\x9a", "\xf0\x9d\x9a\x8a", "\xf0\x9d\x96\xba", "\x61\xcc\xbd\xcd\x90\x00",
		"\x61\xcc\xbd\xcd\x91\x00", "\x61\xcc\xbd\xcd\x92\x00", "\x61\xcc\xbd\xcd\x93\x00", "\x61\xcc\xbd\xcd\x94\x00",
		"\x61\xcc\xbd\xcd\x95\x00", "\x61\xcc\xbd\xcd\x96\x00", "\x61\xcc\xbd\xcd\x97\x00", "\x61\xcc\xbd\xcd\x98\x00",
		"\x61\xcc\xbd\xcd\x99\x00", "\xf0\x9f\x85\x90", "\xf0\x9f\x85\xb0", "\xf0\x9f\x84\xb0", "\xf0\x9d\x94\x9e",
		"\xf0\x9d\x96\x86", "\x61\xcd\x80\x00", "\x61\xcd\x81\x00", "\x61\xcd\x82\x00", "\x61\xcd\x83\x00",
		"\x61\xcd\x84\x00", "\x61\xcd\x85\x00", "\x61\xcd\x86\x00", "\x61\xcd\x87\x00", "\x61\xcd\x88\x00",
		"\x61\xcd\x89\x00", "\x61\xcc\xba\x00", "\x61\xcc\xbb\x00", "\x61\xcc\xbc\x00", "\x61\xcc\xbd\x00",
		"\x61\xcc\xbe\x00", "\x61\xcc\xbf\x00", "\x61\xcc\x9f\x00", "\xf0\x9d\x95\x92", "\x61\xd2\x89\x00",
		"\x61\xcc\xb0\x00", "\x61\xcc\xb1\x00", "\x61\xcc\xb2\x00", "\x61\xcc\xb3\x00", "\x61\xcc\xb4\x00",
		"\x61\xcc\xb5\x00", "\x61\xcc\xb6\x00", "\x61\xcc\xb7\x00", "\x61\xcc\xb8\x00", "\x61\xcc\xb9\x00" ]
	at_exit do
		puts "\n\t\xe3\x8b\xa1\x00"
		s = fonts.sample
	...
	else ARGV.each do |word| word.chars do |w| print w =~ /[a-z]/ ? gen(font, w) : w end end
	end
rescue Exception
end
